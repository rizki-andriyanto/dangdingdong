		...
		<div id="main-wrapper">
					...
					<div class="row">
						...
						<div class="main-column col-9">
							...
							<div class="masonry masonry-3 row">
								...
								include('../blog/first_blog.php');  



								?>

								<article class="blog first col-12">

									<div class="image" style="background-image: url(../assets/img/blog-images/bromo/<?php echo $n_image; ?>.jpg)"></div>
									...
									<div class="inner">
										...
										<header>
											...
											<div class="vcard">
												...
												<div class="date">On <time><?php echo $month ; echo '&nbsp;'.$day; echo ', '.$year;?></time></div>

												<address class="author">by <a href="#" class="fn"><?php echo $author; ?></a></address>
										...
										<a href="detail-blog.php?id=<?php echo $id; ?>" class="read-more">Read more</a>
							...
							<aside class="widget widget-categories inner">
								...
								<div class="widget-content">
									...
									<ul>
										...
										<?php	include('../blog/recent_post.php');  ?>
			...
			<div id="sidebar">
				...
				<footer>
					...
					<p class="copyright"><b>© Copyright 2016 - 2017 ray</b></p>
